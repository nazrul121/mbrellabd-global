...
<div class="row">
    ...
    <?php echo $__env->make('common.season.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        let table = $('.table').DataTable({
            ...
            ajax: "<?php echo e(route('common.season')); ?>",
            order: [ [0, 'desc'] ],
            columns: [
                {data: 'id'},
...
<?php echo $__env->make('common.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-php-8.2\htdocs\laravelapp\resources\views/common/season/index.blade.php ENDPATH**/ ?>