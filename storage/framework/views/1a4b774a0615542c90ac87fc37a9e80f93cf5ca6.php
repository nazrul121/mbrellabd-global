...
<div class="row">
        ...
        <div class="card">
            <div class="card-header"><h5>Campaign dataTable</h5>
                <div class="card-header-right">
                    <?php if(check_access('create-campaign')): ?>
    ...
    <?php echo $__env->make('common.ad.campaign.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        let table = $('.table').DataTable({
            ...
            ajax: "<?php echo e(route('common.campaign')); ?>",
            order: [ [0, 'desc'] ],
            columns: [
                {data: 'id'},
...
<?php echo $__env->make('common.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravelapp/resources/views/common/ad/campaign/index.blade.php ENDPATH**/ ?>