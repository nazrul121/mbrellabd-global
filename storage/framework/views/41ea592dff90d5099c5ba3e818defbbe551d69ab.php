            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="about-hero-content">
                        ...
                        <div class="chawkbazar-privacy-policy-content-single" id="privacy_policy__<?php echo e($key); ?>_f8e4cc6">
                            <h2 class="chawkbazar-privacy-policy-title"><?php echo e($post->title); ?></h2>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="contact-item">
                    ...
                    <div class="contact-details">
                        ...
                        <a class="contact-info" href="mailto:<?php echo e(request()->get('system_email')); ?>"><?php echo e(request()->get('system_email')); ?></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12">
                <div class="contact-item">
                    ...
                    <div class="contact-details">
                        ...
                        <p class="contact-info"><?php echo e(request()->get('office_address')); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12">
                <div class="contact-item">
                    ...
                    <div class="contact-details">
                        ...
                        <a class="contact-info" href="tel:<?php echo e(request()->get('system_phone')); ?>"><?php echo e(request()->get('system_phone')); ?></a>
                        <a class="contact-info" href="tel:<?php echo e(request()->get('system_helpline')); ?>"><?php echo e(request()->get('system_helpline')); ?></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="contact-form-area">
            ...
            <div class="contact-form--wrapper">
                <form action="<?php echo e(url('save-contact')); ?>" class="contact-form" id="contactForm"> <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravelapp/resources/views/page.blade.php ENDPATH**/ ?>