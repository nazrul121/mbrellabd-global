<?php $__env->startSection('title', $promotion_type->title); ?>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header"><h5><b><?php echo e($promotion_type->title); ?></b> dataTable</h5>
                <div class="card-header-right">
                    <?php if(check_access('create-promotion')): ?>
                    <a href="#!" class="btn btn-primary addModal"><i class="feather icon-plus"></i> Add New</a><?php endif; ?>
                </div>
            </div>
            <?php
    ...
    <?php echo $__env->make('common.ad.promotion.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
...
<link rel="stylesheet" href="<?php echo e(asset('back2')); ?>/css/timepicker.min.css">
<script>
    ...
    $(document).ready(function () {
        ...
        let table = $('.promotionTable').DataTable({
            ...
            ajax: "<?php echo e(route('common.promotion',$promotion_type->id)); ?>",
            order: [ [0, 'desc'] ],
            columns: [
                {data: 'id'},
...
<?php echo $__env->make('common.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-php-8.2\htdocs\laravelapp\resources\views/common/ad/promotion/index.blade.php ENDPATH**/ ?>