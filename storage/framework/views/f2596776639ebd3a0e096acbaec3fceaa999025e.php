...
<div class="row">
        ...
        <div class="product-gallery product-gallery-vertical d-flex">
            <div class="product-img-large">
                <div class="qv-large-slider img-large-slider common-slider" data-slick='{
                    ...
                    <div class="zoom img-large-wrapper" data-href="<?php echo e($product->feature_photo); ?>">
                        <img src="<?php echo e($product->feature_photo); ?>" alt="img">
                    </div>
                    ...
                    <?php $__currentLoopData = $product->product_photos()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$ph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="zoom img-large-wrapper" data-href="<?php echo e($ph->photo); ?>">
                            <img src="<?php echo e($ph->photo); ?>" class="zoomImg">
                        </div>
                    ...
                    <?php $__currentLoopData = $colorPhotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$cp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="zoom img-large-wrapper" data-href="<?php echo e($cp->photo); ?>">
                            <img src="<?php echo e($cp->photo); ?>" class="zoomImg">
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>              
                </div>
            </div>
            <div class="product-img-thumb">
                <div class="qv-thumb-slider img-thumb-slider common-slider" data-vertical-slider="true" data-slick='{
                    ...
                    <?php $__currentLoopData = $product->product_photos()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$ph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <div class="img-thumb-wrapper">
                                <img src="<?php echo e($ph->photo); ?>" alt="img">
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php $__currentLoopData = $colorPhotos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$cp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <div class="img-thumb-wrapper">
                                <img src="<?php echo e($cp->photo); ?>" alt="img">
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
    ...
    <div class="col-lg-6 col-md-12 col-12">
        <div class="product-details ps-lg-4">
            ...
            <h2 class="product-title mb-3"><?php echo e($product->title); ?></h2>
            ...
            <div class="product-price-wrapper mb-4">
                ...
                <?php if(product_price($product->id, $product->sale_price) < $product->sale_price): ?>
                    <?php if($new < $old ): ?><del class="product-price compare-price ms-2"><?php echo e(Session::get('user_currency')->currencySymbol); ?> <?php echo e(number_format($old,$formatNumber)); ?></del> <?php endif; ?>
            ...
            <div class="product-sku product-meta mb-1"> <strong class="label">Product Code:</strong> <?php echo e($product->design_code); ?> </div>
                            ...
                            <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2=> $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(strpos(strtolower($pvo->variation->title), 'color') !== false): ?>
                                    <li class="variant-item colorV" title="<?php echo e($option->variation_option->title); ?>" data-title="<?php echo e($option->variation_option->title); ?>" data-value="<?php echo e($option->variation_option_id); ?>" data-variation="<?php echo e($pvo->variation_id); ?>" role="radio"> &nbsp; 
                                        <button type="button" class="colorbtn2"  data-product_id="<?php echo e($product->id); ?>" data-option_id="<?php echo e($option->variation_option_id); ?>" 
            ...
            <div class="misc d-flex align-items-end justify-content-between mt-4">
                <div class="quantity d-flex align-items-center justify-content-between">
                    <button class="qty-btn dec-qty"><img src="<?php echo e(url('/assets/img/icon/minus.svg')); ?>" alt="minus"></button>
                    <input class="qty-input" type="number" name="quantity" value="1" min="0">
                    <button class="qty-btn inc-qty"><img src="<?php echo e(url('/assets/img/icon/plus.svg')); ?>" alt="plus"></button>
                </div>
            ...
            <form class="product-form" action="#">
                <div class="product-form-buttons d-flex align-items-center justify-content-between mt-4">
                    <?php if(request()->get('addToCart')=='1'): ?>
                        ...
                        <?php else: ?>
                            <button type="button" class="position-relative btn-atc btn-add-to-cart loader button" data-id="<?php echo e($product->id); ?>">ADD TO CART</button>
                        <?php endif; ?>
                    <?php else: ?> 
                ...
                <div class="buy-it-now-btn mt-2">
                    <a href="<?php echo e(route('product',[app()->getLocale(),$product->slug])); ?>" class="position-relative btn-atc btn-buyit-now">Product Details</a>
                </div>
            </form>                   
...
<script src="<?php echo e(asset('/assets/zoom/jquery.zoom.js')); ?>"></script>
...
<script>
	...
	$('.product-img-thumb .slick-list').css('min-height','40vh')
        ...
        $('.action-wishlist').on('click',function(){
            ...
            $.get(url+"/<?php echo e(app()->getLocale()); ?>/add-to-wishlist/"+id, function( data ) {
                $('#notice').fadeIn('slow');
...
<?php /**PATH D:\xampp-php-8.2\htdocs\laravelapp\resources\views/includes/quickView.blade.php ENDPATH**/ ?>