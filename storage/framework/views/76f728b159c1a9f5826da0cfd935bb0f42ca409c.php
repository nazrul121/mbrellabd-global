<table class="table">
    ...
    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if($is_variation=='yes'): ?>
            ...
            <tr class="">
                <td class="p-0 pt-2">
                    <label for="pp<?php echo e($comb->id); ?>" class="pl-3">
                        <input type="checkbox" class="product" data-comb="<?php echo e($comb->id); ?>" style="width:25px;height:30px;"
                        <?php if($check->count()>0): ?>disabled <?php endif; ?> <?php echo e($checkUncheck); ?> id="pp<?php echo e($comb->id); ?>" name="product_ids[]" value="<?php echo e($product->id); ?>">

                        <div style="position:relative;float:right;font-size:17px;padding-left:1em;padding-right:1em;margin-top:-6px;">  <?php echo e($product->title); ?>

                            <input type="checkbox" style="width:25px;height:25px;" class="v<?php echo e($comb->id); ?>" name="combination_id[]" value="<?php echo e($comb->id); ?>"  
                            ...
                            <img src="<?php echo e($product->thumbs); ?>" style="height:35px">
                        </div>
                    </label>
            ...
            <tr class="">
                <td class="p-0 pt-2">
                    <label for="proudct<?php echo e($product->id); ?>">
                        <input type="checkbox" style="width:25px;height:25px;" <?php if($check->count()>0): ?>disabled checked <?php endif; ?> <?php echo e($checkUncheck); ?> id="proudct<?php echo e($product->id); ?>" name="product_ids[]" value="<?php echo e($product->id); ?>">
...
<?php /**PATH D:\xampp-php-8.2\htdocs\laravelapp\resources\views/common/ad/promotion/flat/show-products.blade.php ENDPATH**/ ?>