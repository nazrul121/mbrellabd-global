...
<script>
    $(function(){
        ...
        $('#toGo').on('change', function(){
            if ($('#toGo').prop('checked')) {
                ...
                $('#addSummaryT').prop('action',"<?php echo e(route('common.promotion.show-form',$promotion->id)); ?>")
                $(".showProducts").html('');
                ...
                $('#addSummary').prop('action',"<?php echo e(route('common.promotion.save-form',$promotion->id)); ?>")
    ...
    function get_inner_category_products(cat_id) {
        ...
        $.ajax({
            url: url + '/common/get-inner-group-products/'+ group_id +'/<?php echo e($promotion->id); ?>',
            method: "GET",
    ...
    function get_child_category_products(cat_id) {
        ...
        $.ajax({
            url: url+'/common/get-child-group-products/'+cat_id+'/<?php echo e($promotion->id); ?>/unchecked/',
            method: "GET",
...
<?php /**PATH D:\xampp-php-8.2\htdocs\laravelapp\resources\views/common/ad/promotion/flat/form.blade.php ENDPATH**/ ?>