            ...
            <div class="container">
                ...
                <div class="article-card-container position-relative">
                    ...
                    <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $cat = $blog->blog_categories()->select('blog_categories.id','blog_categories.title')->orderBy('id','DESC')->first(); 
                        // dd($cat);
                        ?>
...
<?php /**PATH D:\xampp-php-8.2\htdocs\laravelapp\resources\views/includes/blog.blade.php ENDPATH**/ ?>