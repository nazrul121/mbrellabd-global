    ...
    <div class="row text-right" id="searchForm">
        ...
        <div class="col-sm-2">
            <select class="form-control" name="category_id">
                ...
                <option value="<?php echo e($type->id); ?>" <?php if(request()->category_id==$type->id): ?>selected <?php endif; ?>><?php echo e($type->title); ?></option>
    ...
    <table class="table table-hover bg-white productTbl mt-5" style="width:100%">
        ...
        <tbody>
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr class="">
                    <td class="p-0 pt-2">
                        <label for="proudct<?php echo e($item->id); ?>" class="pl-3">
                            <input type="checkbox" <?php if($check->count()>0): ?>disabled checked <?php endif; ?> style="width:25px;height:25px;" id="proudct<?php echo e($item->id); ?>" name="product_ids[]" value="<?php echo e($item->id); ?>">
                            <div style="position:relative;float:right;font-size:17px;padding-left:1em;padding-right:1em;margin-top:-4px;">
                                <?php echo e($item->title); ?> : <?php echo e($item->design_code); ?> <img src="<?php echo e($item->thumbs); ?>" style="height:40px">
                            </div>
                        </label>
                    </td>
                </tr>
    ...
    <script>
            ...
            $.ajax({ url:"/common/main2sub-categories-promotion/<?php echo e($promotion->id); ?>/"+ cat_id, method:"get",
                success:function(data){
                    $.each(data, function(index, value){
                        const selectedAttr = value.id == "<?php echo e(request()->sub_category_id); ?>" ? ' selected' : '';
        ...
        function child_categories(sub_cat){
            $.ajax({ url:"/common/sub2child-categories-promotion/<?php echo e($promotion->id); ?>/"+ sub_cat, method:"get",
                success:function(data){
                    $.each(data, function(index, value){
                        const selectedAttr = value.id == "<?php echo e(request()->child_category_id); ?>" ? ' selected' : '';
...
<?php if(request()->category_id): ?>
    <script>
        setTimeout(() => {
            sub_categories("<?php echo e(request()->category_id); ?>")
        }, 200);

        setTimeout(() => {
            child_categories("<?php echo e(request()->sub_category_id); ?>")
        }, 400);
    </script>
<?php endif; ?>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('common.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-php-8.2\htdocs\laravelapp\resources\views/common/ad/promotion/flat/form2.blade.php ENDPATH**/ ?>