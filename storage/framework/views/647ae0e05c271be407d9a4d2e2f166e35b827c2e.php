<?php $__env->startSection('title',$blog->title.' | '.request()->get('system_title')); ?>

<?php $__env->startPush('meta'); ?>
    <meta property="og:url" content="<?php echo e(url()->full()); ?>" />
    <meta property="og:type" content="website">
    <meta property="og:title" content="<?php echo e($blog->title.' | '.request()->get('system_title')); ?>">
<?php $__env->stopPush(); ?>
...
<div class="breadcrumb">
    <div class="container">
        <ul class="list-unstyled d-flex align-items-center m-0">
            ...
            <li><a href="<?php echo e(route('blog',app()->getLocale())); ?>">Blog</a></li>
            ...
            <div class="col-lg-9 col-md-12 col-12">
                <div class="article-rte">
                    <div class="article-img">
                        <img src="<?php echo e(url('storage/'.$blog->photo)); ?>" alt="<?php echo e($blog->title); ?>">
                    </div>
                    <div class="article-meta">
                        <h2 class="article-title"><?php echo e($blog->title); ?></h2>
                        <div class="article-card-published text_14 d-flex align-items-center">
                            <span class="article-author d-flex align-items-center">
                                ...
                                <span class="ms-2"><?php echo e(date('F j, Y',strtotime($blog->created_at))); ?></span>
                            </span>
                            ...
                            <a href="#" class="article-date d-none d-sm-flex align-items-center">
                                ...
                                <span class="ms-2"><?php echo e($cat->title); ?></span>
                            </a> &nbsp;
                    ...
                    <div class="article-content">
                        <figure class="blockquote pl-0">
                            <blockquote>
                                <pre style="background: white;white-space: break-spaces;padding: 5px;margin: 0;color:black;"><?php echo $blog->description; ?></pre>
                            </blockquote>
                        </figure>
                    </div>
                            ...
                            <ul class="filter-lists list-unstyled mb-0">
                                ...
                                <li class="filter-item">
                                    <a class="filter-label" href="#">
                                        <input type="checkbox" /><span class="filter-checkbox rounded me-2"></span> <?php echo e($cat->title); ?>
                        ...
                        <div class="filter-related">
                            ...
                            <div class="related-item related-item-article d-flex">
                                <div class="related-img-wrapper">
                                    <img class="related-img" src="<?php echo e(url('storage/'.$item->photo)); ?>" alt="<?php echo e($item->title); ?>">
                                </div>
                                <div class="related-product-info">
                                    <h2 class="related-heading text_14">
                                        <a href="<?php echo e(route('news',[app()->getLocale(), $item->slug])); ?>"><?php echo e($item->title); ?></a>
                                    </h2>
                                    <p class="article-card-published text_12 d-flex align-items-center mt-2">
                                        <span class="article-date d-flex align-items-center">
                                            ...
                                            <span class="ms-2"><?php echo e(date('F j, Y',strtotime($item->created_at))); ?></span>
                                        </span>
                                    </p>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravelapp/resources/views/blog-info.blade.php ENDPATH**/ ?>