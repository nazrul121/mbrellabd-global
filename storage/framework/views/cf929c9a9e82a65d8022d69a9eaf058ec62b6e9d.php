...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('customer.address.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    $(document).ready(function () {
        ...
        let table = $('.table').DataTable({
            ...
            ajax: "<?php echo e(route('customer.address',app()->getLocale())); ?>",
            order: [ [0, 'desc'] ],
            columns: [
        ...
        $('.table').on('click','.edit',function(){
            ...
            $.ajax({
                url: url+"/<?php echo e(app()->getLocale()); ?>/customer/addresses/single-item/"+id,
                ...
                success: function (data) {
                    ...
                    $('#editForm').attr('action', url+'/<?php echo e(app()->getLocale()); ?>/customer/addresses/update/'+data.id);
...
<?php echo $__env->make('customer.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-php-8.2\htdocs\laravelapp\resources\views/customer/address/index.blade.php ENDPATH**/ ?>