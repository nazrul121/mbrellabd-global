<?php $__env->startPush('meta'); ?>
    ...
    <meta property="og:title" content="<?php echo e($season->title); ?>" />

    <?php
       
    ?> 
    <meta property="og:image" content="<?php echo e(asset($season->photo)); ?>">
    <meta property="og:image:secure_url" content="<?php echo e(asset($season->photo)); ?>">
    <meta property="og:image:type" content="image/jpg">
    <meta property="og:image:width" content="1200"> <!-- Adjust according to your image dimensions -->
...
?>
<?php $__env->startSection('title',$season->title.' Products | '.request()->get('system_title')); ?>
...
<?php $__env->startSection('content'); ?>
                                ...
                                <div class="product-card">
                                    ...
                                    <div class="product-card-details">
                                        ...
                                        <h3 class="product-card-title">
                                            <a href="<?php echo e(route('product',[app()->getLocale(),$product->slug])); ?>">
    ...
    <div class="modal fade" id="chirtModal" tabindex="-1" aria-hidden="true" style="display: none;">
        <pre style="padding:0;margin:0px;background:none;"><?php echo e($season->description); ?></pre>
    </div>
<?php $__env->stopSection(); ?>
<?php $__env->startPush('style'); ?>
<link rel="stylesheet" id="elementor-post-2497-css" href="<?php echo e(asset('assets/css/autoptimize_single_d7ee6d44fbf5ddc562ecccf7eb18303c.css')); ?>" type="text/css" media="all" />
<style>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-php-8.2\htdocs\laravelapp\resources\views/season-products.blade.php ENDPATH**/ ?>