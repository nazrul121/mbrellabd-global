...
<div class="wishlist-page mt-100">
    <div class="wishlist-page-inner">
        <div class="container">
            ...
            <hr>
            <div class="row">
                <?php $__currentLoopData = $wishlists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="col-lg-3 col-md-6 col-6 row<?php echo e($key); ?>" data-aos="fade-up" data-aos-duration="700">
                    <div class="product-card">
                        <div class="product-card-img">
                            <a class="hover-switch" href="<?php echo e(url('product').'/'.$cart->product->slug); ?>">
                                <img class="primary-img" src="<?php echo e(url('storage').'/'.$cart->product->thumbs); ?>" alt="product-img">
                            </a>
                            <?php if($percent >0): ?>
                            ...
                            <?php if(is_stock_out($cart->product_id)): ?>
                                <div class="product-badge">
                            ...
                            <div class="product-card-action product-card-action-2 justify-content-center">
                                <a href="#quickview-modal" class="action-card action-quickview" data-product_id="<?php echo e($cart->product_id); ?>" data-bs-toggle="modal">
                                ...
                                <a href="javascript:;" class="action-card remove-wishlist" title="Remove form Wishlist" data-id="<?php echo e($cart->id); ?>" data-key="<?php echo e($key); ?>" >
                                ...
                                <a href="#" class="action-card action-addtocart" data-product_id="<?php echo e($cart->product_id); ?>" data-variation="<?php echo e($cart->product->product_variation_options()->count()); ?>" >
                        ...
                        <div class="product-card-details">
                            <ul class="color-lists list-unstyled d-flex align-items-center">
                                <?php $__currentLoopData = $cart->product->product_variation_options()->where('variation_id',$listViewVariationId)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pvo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <button type="button" title="<?php echo e($pvo->variation_option->title); ?>" class="colorbtn" thumb="/storage/<?php echo e($thumb); ?>" data-product_id="<?php echo e($cart->product_id); ?>" data-option_id="<?php echo e($pvo->variation_option_id); ?>" 
                            ...
                            <h3 class="product-card-title">
                                <a href="<?php echo e(url('product').'/'.$cart->product->slug); ?>"><?php echo e($cart->product->title); ?></a>
                            </h3>
                            <input type="hidden" name="cart_id[]" value="<?php echo e($cart->id); ?>">
                            <div class="product-card-price">
                                <span class="card-price-regular"><?php echo e(Session::get('user_currency')->symbol. product_price($cart->product_id, $cart->product->sale_price)); ?></span>
                                <?php if($new < $old ): ?>
                                    <span class="card-price-compare text-decoration-line-through amount"><?php echo e(Session::get('user_currency')->symbol); ?><?php echo e(number_format($old,$formatNumber)); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <?php if($wishlists->count() < 1): ?>
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="cart-total-area">
                        <div class="cart-total-box m-4">
                            <p class="shipping_text text-center">No Product added</p>
                            <div class="d-flex justify-content-center mt-1">
                                <a href="<?php echo e(url('products')); ?>" class="position-relative btn-primary text-uppercase">
                                    Continue Shopping
                                </a>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravelapp/resources/views/wishlist.blade.php ENDPATH**/ ?>