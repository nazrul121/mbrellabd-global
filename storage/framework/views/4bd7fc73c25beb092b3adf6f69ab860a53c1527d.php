            ...
            <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <li class="filter-item">
                    <label class="filter-label checkCategory">
                        <input type="checkbox" name="group_id" <?php if(request()->get('category') !='' && strpos( str_replace(' ','-',request()->get('category') ), $group->id.'-'.$group->slug ) !== false): ?> checked <?php endif; ?>
                            value="<?php echo e($group->id.'-'.$group->slug); ?>" />
                        <span class="filter-checkbox rounded me-2"></span>
                        <span class="filter-text"><?php echo e($group->title); ?></span>
                    </label>
                </li>
                <?php endif; ?>
...
<div class="filter-widget">
    ...
    <div id="filter-availability<?php echo e($key); ?>" class="accordion-collapse collapse show">
        <ul class="filter-lists list-unstyled mb-0 variantScroll">
            <?php $__currentLoopData = $variation->variation_options()->orderBy('title','asc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $checkVo = \App\Models\Product_variation_option::where('variation_option_id',$row->id)->whereIn('product_id',$product_ids);?>
                ...
                <li class="filter-item">
                    <label class="filter-label colors">
                        ...
                        value="<?php echo e($row->id.'-'.$row->title); ?>" />
    ...
    <div id="filter-price" class="accordion-collapse collapse show">
        <div class="filter-price d-flex align-items-center justify-content-between">
            <div class="filter-field">
                <input class="field-input minNumber" type="number" placeholder="<?php echo e(Session::get('user_currency')->currencySymbol); ?> 0" min="0" value="<?php echo e($min); ?>" max="2000.00">
            </div>
            <div class="filter-separator px-3">To</div>
            <div class="filter-field">
                <input class="field-input maxNumber" type="number" min="0" placeholder="<?php echo e(Session::get('user_currency')->currencySymbol.$max); ?>" value="<?php echo e($max); ?>" max="2000.00">
            </div>
        </div>
        <br>
...
<?php /**PATH D:\xampp-php-8.2\htdocs\laravelapp\resources\views/includes/product/promo/filter.blade.php ENDPATH**/ ?>