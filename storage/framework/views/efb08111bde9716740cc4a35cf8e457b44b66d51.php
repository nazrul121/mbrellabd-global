...
?>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header"><h5><b><?php echo e($order_status->title); ?></b>  dataTable</h5>
                    <button class="btn btn-sm btn-secondary readyBtn" disabled>Ready to Ship</button>

                    <div class="card-header-right">
                        <div class="input-daterange input-group" id="datepicker_range">
                            <input type="text" class="form-control text-left" placeholder="Start date" name="start" value="<?php echo e(str_replace('-','/',Request::segment(4))); ?>">
                            <input type="text" class="form-control text-right" placeholder="End date" name="end" value="<?php echo e(str_replace('-','/',Request::segment(5))); ?>">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered orderTable" style="width:100%">
                            <thead>
                                <tr><th> <?php if($order_status->id=='3'): ?><input type="checkbox" id="checkAll" style="width:25px;height:25px"> <?php else: ?> # <?php endif; ?> </th>
    ...
    <?php echo $__env->make('common.order.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('common.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-php-8.2\htdocs\laravelapp\resources\views/common/order/index.blade.php ENDPATH**/ ?>