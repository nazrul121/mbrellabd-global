                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                    <div class="elementor-section elementor-top-section elementor-element elementor-element-26bc74a elementor-section-full_width elementor-section-height-default elementor-section-height-default">
                        <div class="row mt-4">
                            ...
                            <?php if($sizeChirt): ?>
                                <iframe width="100%" height="800" src="/<?php echo e($sizeChirt); ?>" frameborder="0"></iframe>
                            <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravelapp/resources/views/size-guird.blade.php ENDPATH**/ ?>