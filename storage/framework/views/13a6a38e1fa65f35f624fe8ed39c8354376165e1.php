<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-12">
            <form class="card" action="<?php echo e(route('common.make-order')); ?>"><?php echo csrf_field(); ?>
                ...
                <div class="card-body">
                    <?php if(Session::has('success')): ?> <p class="alert alert-success"><i class="fa fa-check text-warning"></i> <?php echo e(Session::get('success')); ?></p> <?php endif; ?>
                    <?php if(Session::has('error')): ?> <p class="alert alert-danger"><i class="fa fa-times text-warning"></i> <?php echo e(Session::get('error')); ?></p> <?php endif; ?>
                        ...
                        <table class="table table-hover table-bordered" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    <?php if(Session::has('address')): ?>
                                    <td>
                                        Name: <?php echo e(Session::get('address')['fname'].' '.Session::get('address')['lname']); ?> <br>
                                        Phone No: <?php echo e(Session::get('address')['phone']); ?> <br>
                                        Area: <?php echo e(\DB::table('divisions')->where('id',Session::get('address')['division'])->pluck('name')->first()); ?> <i class="fa fa-arrow-right"></i>
                                        <?php echo e(\DB::table('districts')->where('id',Session::get('address')['district'])->pluck('name')->first()); ?>  <i class="fa fa-arrow-right"></i>
                                        <?php echo e(\DB::table('cities')->where('id',Session::get('address')['city'])->pluck('name')->first()); ?> <br>
                                        Address: <?php echo e(Session::get('address')['address']); ?>


                                    </td>
                                    <td>

                                        <?php if(array_key_exists('same', Session::get('address'))): ?>
                                            Name: <?php echo e(Session::get('address')['fname'].' '.Session::get('address')['lname']); ?> <br>
                                            Phone No: <?php echo e(Session::get('address')['phone']); ?> <br>
                                            Area: <?php echo e(\DB::table('divisions')->where('id',Session::get('address')['division'])->pluck('name')->first()); ?> <i class="fa fa-arrow-right"></i>
                                            <?php echo e(\DB::table('districts')->where('id',Session::get('address')['district'])->pluck('name')->first()); ?>  <i class="fa fa-arrow-right"></i>
                                        ...
                                        <?php else: ?>
                                            Name: <?php echo e(Session::get('address')['shipping_fname'].' '.Session::get('address')['shipping_lname']); ?> <br>
                                            Phone No: <?php echo e(Session::get('address')['shipping_phone']); ?> <br>
                                            Area: <?php echo e(\DB::table('divisions')->where('id',Session::get('address')['shipping_division'])->pluck('name')->first()); ?>  <i class="fa fa-arrow-right"></i>
                                            <?php echo e(\DB::table('districts')->where('id',Session::get('address')['shipping_district'])->pluck('name')->first()); ?>  <i class="fa fa-arrow-right"></i>
                                            <?php echo e(\DB::table('cities')->where('id',Session::get('address')['shipping_city'])->pluck('name')->first()); ?> <br>
                                            Address: <?php echo e(Session::get('address')['shipping_address']); ?>
                    ...
                    <a href="<?php echo e(route('common.refresh-create-order')); ?>" class="btn btn-light float-right"> <i class="feather icon-remove"></i> Cancel order</a>
                </div>

            </form>
        </div>
    </div>
    <?php echo $__env->make('common.order.create.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".itemTable" ).load( "<?php echo e(route('common.order-items')); ?>" );
        ...
        $('#title').on('keyup', function(){
            ...
            if(query.length >1){
                $.ajax({
                    url:"<?php echo e(route('common.searach-products')); ?>",
...
<?php echo $__env->make('common.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravelapp/resources/views/common/order/create/index.blade.php ENDPATH**/ ?>