...
<div class="row">
    ...
    <form id="addForm" class="col-12" style="position:relative;top:-25px" action="<?php echo e(route('common.product.store')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('common.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-php-8.2\htdocs\laravelapp\resources\views/common/product/create.blade.php ENDPATH**/ ?>