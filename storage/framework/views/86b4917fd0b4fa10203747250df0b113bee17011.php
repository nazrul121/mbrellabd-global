    ...
    <?php if(old('division')): ?>
        <script>
            setTimeout(function() {
                ...
                get_district("<?php echo e(old('shipping_division')); ?>");
                get_cities("<?php echo e(old('shipping_district')); ?>");
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravelapp/resources/views/checkout.blade.php ENDPATH**/ ?>