...
var content = $('<div class="timepicker">\
		<div v-show class="title">please choose</div>\
			<div class="chose-all">\
				<div class="handle">\
				...
				<div class="text">\
					<div class="cell-4"><a class="js-hour-show" title="When choosing"></a></div>\
					<div class="cell-2">:</div>\
					<div class="cell-4"><a class="js-minute-show" title="Choice points"></a></div>\
				</div>\
				<div class="handle">\
...
timepicker.bindEvent = function () {
	...
	// 选择分钟
		...
		thisTimePicker.title.text('please choose');
	...
	thisTimePicker.hourShow.on('click',function() {
		...
		thisTimePicker.title.text('select the hour');
	});
	...
	thisTimePicker.minuteShow.on('click',function() {
		...
		thisTimePicker.title.text('select the minute');
	});
};
