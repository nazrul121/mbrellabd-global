<div class="modal fade"  id="addMetaModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="addMetaForm" class="modal-content" action="{{ route('common.group-meta.create') }}" method="post" enctype="multipart/form-data"> @csrf
            ...
            <div class="modal-body">
                ...
                @include('common.category.main.meta.form')
