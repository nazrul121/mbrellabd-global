...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header"><h5>Update contents of <b>{{ $policy->title }}</b></h5>
                <div class="card-header-right">
                    <a href="{{ route('common.policy',$policy_type->slug) }}" class="btn btn-outline-primary addModal"><i class="feather icon-list"></i> View Posts</a>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <form id="addForm" class="container" action="{{ route('common.policy.update',$policy->id) }}" method="post" enctype="multipart/form-data"> @csrf
