    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
           <form action="{{ route('common.order.save-address') }}" method="post" id="addressForm">@csrf

                <div class="billingForm"> @include('common.order.create.billing-address') </div>

                <div class="shippingForm"> @include('common.order.create.shipping-address') </div>
...
<div class="modal fade" id="itemModal" tabindex="-1" role="dialog" aria-labelledby="itemModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ route('common.order.create') }}" method="get" id="addToCart">@csrf
                ...
                {{-- <div class="variations row mt-2 p-2"></div> --}}
