            ...
            <div class="card">
                <div class="row mt-2 p-2">
                    ...
                    <div class="col-md-5 text-right">
                        ...
                        <a href="{{route('common.invoice-base-reports')}}" class="btn btn-warning btn-sm">Order base Report</a>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <h3 class="title">Product base order report
                        <small class="float-md-right"><a class="btn btn-sm btn-primary" href="{{route('common.deliverd-order-info')}}?start_date={{ request()->start_date }}&end_date={{ request()->end_date }}"> Deliverd Orders</a></small>
                    </h3>
