...
<div class="row">
        ...
        <div class="card">
            <div class="card-header"><h5>Product copy entry</h5>
                <div class="card-header-right">
                    <a href="{{ route('common.product') }}" class="btn btn-outline-primary"><i class="feather icon-list"></i> View products</a>
                </div>
            </div>
    ...
    <form id="addForm" class="col-12" style="position:relative;top:-25px" action="{{ route('common.product.store') }}" method="post" enctype="multipart/form-data"> @csrf
        @include('common.product.copy.form')
    </form>
</div>
@endsection
