...
<div class="row">
    <div class="col-12">
        <div class="card">
            <p class="alert alert-info"> <img src="{{ $product->thumbs }}" height="30"> {{ $product->title.' ('.$product->id.')' }}
...
@include('common.product.variation-photo.modal')
...
<script>
    ...
    $(document).ready(function () {
        ...
        let table = $('.productColor').DataTable({
            ...
            ajax: "{{route('common.product.variation.photo',$product->id)}}",
            columns: [
                {data: 'id'},
