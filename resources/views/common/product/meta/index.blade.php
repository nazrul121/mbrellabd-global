...
<div class="row">
        ...
        <div class="card">
            <div class="card-header"><h5>Product <code>Meta description</code></h5>
                <div class="card-header-right">
                    ...
                    <a href="#" class="btn btn-outline-primary addModal"><span class="feather icon-plus"></span> Create Meta</a>@endif
                </div>
            </div>
    ...
    @include('common.product.meta.modal')
</div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        let table = $('.metaTable').DataTable({
            ...
            ajax: "{{route('common.product-meta',$product->id)}}",
