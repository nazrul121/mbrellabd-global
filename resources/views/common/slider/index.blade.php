        ...
        <div class="card">
            <div class="card-header"><h5>Sliders dataTable</h5>
                <div class="card-header-right">
                    @if (check_access('create-home-slider'))
    ...
    $(document).ready(function () {
        $( ".slider_row" ).sortable({
            ...
            update  : function(event, ui){
                ...
                $('.slider_row tr').each(function(){ page_id_array.push($(this).attr("id")); });

                $.ajax({
                    url:"{{route('common.slider-ordering')}}",method:"get",
        ...
        $('.table').on('click','.edit',function(){
            ...
            let id = $(this).attr('id');
            $.ajax({
                url: url+"/common/page-post/slider/single-item/"+id,
                ...
                success: function (data) {
                    ...
                    $('#editForm').attr('action', url+'/common/page-post/slider/update/'+id);
                    if(data.status == 1){
        ...
        $('.table').on('click', '.delete' ,function(e){
            if(confirm('Are you sure to remove the record permanently?? --- There is no Undo option')){
                let id = $(this).attr('id')
                $.ajax({
                    url: url+"/common/page-post/slider/delete/"+id+"",
                    dataType:"json",
                    success:function(data){
