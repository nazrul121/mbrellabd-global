...
@section('content')
    ...
    <div class="login-page mt-100" id="formArea">
        <div class="container">
            ...
            <form class="login-form common-form mx-auto mb-5 border border-info" id="loginForm" action="{{ route('login') }}" method="post"> @csrf
                @if(session('status'))
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <fieldset>
                            ...
                            <input type="text" class="" name="username" value="{{ old('username') }}"/>
                    ...
                    <div class="col-12">
                        <fieldset>
                            <div class="form-checkbox d-flex">
                                <input id="remeberMe" style="width:28px;height:20px;" type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }} >
                                <label for="remeberMe" class="form-check-label ms-2">  {{ __('Remember Me') }} </label>
                            </div>
                        </fieldset>
                    </div>
                    ...
                    <input type="hidden" name="previousRoute" value="{{ $lastPart }}">

                    <div class="col-12">
                        <button type="submit" class="btn-primary d-block mt-2 btn-signin">SIGN IN</button>
                        <a href="{{route('password.request')}}" class="text_14 d-block mt-4 text-end">Forgot your password?</a>
                    </div>

                    <div class="col-12 mt-4">
                        <div class="col-md-12">
                            <a href="{{ url('auth/google') }}" class="btn-secondary mt-2 btn-signin">
                                <strong><i class="fab fa-google"></i> Login With Google</strong>
                            </a>
                            <a class="btn-secondary mt-2 btn-signin" href="{{ url('auth/facebook') }}" id="btn-fblogin">
