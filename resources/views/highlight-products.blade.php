...
<?php
    ...
    $min = 0;// \DB::table('products')->min('sale_price');
    if($max <1) $max += 3;
...
@push('meta')
    ...
    @if($meta_data->count() >0)
        @foreach ($meta_data as $item)
         <meta property="og:{{$item->type}}" content="{{$item->content}}" />
        @endforeach
    @endif
@endpush
                ...
                <div class="col-lg-12 col-md-12 col-12">
                    ...
                    <div class="collection-product-container">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-6" data-aos="fade-up" data-aos-duration="{{$key+660}}">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="/product/{{ $product->slug }}">
                                            <img class="primary-img img{{ $product->id }}" src="{{ url('storage').'/'.$product->thumbs }}" alt="product-img">
                                        </a>
                                        @if($percent >0)
                                    ...
                                    <div class="product-card-details">
                                        ...
                                        <ul class="color-lists list-unstyled d-flex align-items-center">
                                            ...
                                            <button type="button" title="{{ $pvo->variation_option->title }}" class="colorbtn" thumb="/storage/{{ $thumb }}" data-product_id="{{ $product->id }}" data-option_id="{{ $pvo->variation_option_id }}" 
