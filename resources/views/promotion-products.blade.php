...
@push('meta')
    ...
    <meta property="og:title" content="{{$promotion->title.' | '.request()->get('system_title')}}" />
@endpush
        ...
        <div class="container">
            <div class="row flex-row-reverse">
                ...
                <div class="col-lg-9 col-md-12 col-12">
                    @include('includes.product.sorting',['page'=>'promo', 'title'=>$promotion->title,'class'=>'promoDetails'])
                    

                    <div class="collection-product-container">
                        <div class="row">
                            @if( ( $products->count() >0 && $curdate <= $expiry ) || $promotion->status=='1')
                                ...
                                <?php
                                    ...
                                    // dd($old, $new);
                                ?>
                                <div class="col-lg-3 col-md-4 col-6" data-aos="fade-up" data-aos-duration="{{$key + 750}}">
                                        ...
                                        <div class="product-card-img">
                                            ...
                                            @if($percent >0)
                                                <div class="product-badge">
                                                    <span class="badge-label badge-percentage rounded">{{ number_format($percent) }} % off</span>
                                                </div>
                                            @endif
                                                ...
                                                <div class="cart-total-area">
                                                    <div class="cart-total-box mt-4">
                                                        ...
                                                        <div class="d-flex justify-content-center mt-1">
                                                            <a href="{{route('promo-items',[app()->getLocale(), $promotion->slug] )}}" class="position-relative btn-primary text-uppercase">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content newsletter-modal-content">
                <div class="modal-header border-0">
                    <h5 class="modal-title" id="exampleModalLabel">{{$promotion->title}}</h5>
