                            ...
                            <div class="common-slider" data-slick='{
                                ...
                                @foreach ($feeds as $feed)
                                    ...
                                    <div class="instagram-card">
                                        <a class="instagram-img-wrapper" href="{{ $feed->permalink }}"  target="_blank" tabindex="0">
                                            <img src="{{ $feed->url }}" alt="img" class="instagram-card-img rounded" style="height:228px">
                                        </a>
                                    </div>
                                    @endif
                                @endforeach
