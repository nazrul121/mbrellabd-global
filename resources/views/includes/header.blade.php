            ...
            <div class="row align-items-center">
                <div class="col-lg-2 col-md-2 col-6">
                    <div class="header-logo">
                        <a href="{{route('home')}}" class="logo-main">
                            <img class="logoHeight" src="{{ url('storage').'/'.request()->get('header_logo') }}" loading="{{ request()->get('system_domain') }}">
                        </a>
                    </div>
                </div>
                        ...
                        <ul class="main-menu list-unstyled justify-content-center">
                                ...
                                <div class="submenu-transform submenu-transform-desktop container">
                                    <div class="bg-transparent-black">
                                        <ul class="submenu megamenu-container list-unstyled">
                                            @foreach ($cat->inner_groups()->whereIn('id',$countrySubCats)->where('status','1')->orderBy('sort_by')->get() as $key=>$sub)
                                            ...
                                            <li class="menu-list-item nav-item-sub">
                                                <div class="mega-menu-header">
                                                    <a class="nav-link-sub nav-text-sub megamenu-heading text-white"
                                                        href="{{ route('group-in',[app()->getLocale(),$sub->slug]) }}">{{ $sub->title }}
                                                    </a>
                                                </div>
                                                <div class="submenu-transform megamenu-transform">
                                                    <ul class="megamenu list-unstyled">
                                                        @foreach ($sub->child_groups()->whereIn('id',$countryChildCats)->where('status','1')->orderBy('sort_by')->get() as $child)
                                                        <li class="menu-list-item nav-item-sub">
                                        ...
                                        <div class="bg-transparent-black">
                                            <ul class="submenu megamenu-container list-unstyled">
                                                @foreach ($groups as $key=>$item)
                                                    ...
                                                    <li class="menu-list-item nav-item-sub">
                                                        <div class="mega-menu-header">
                                                            <a class="nav-link-sub nav-text-sub megamenu-heading text-white" href="{{ route('season-group', [app()->getLocale(), $season->slug,$item->group->slug]) }}">{{ $item->group->title }}</a>
                                                            &nbsp; <a class="nav-link-sub nav-text-sub megamenu-heading text-white" href="javaScript:;"><span class="text-white"> > </span></a> &nbsp;
                                                            <a class="nav-link-sub nav-text-sub megamenu-heading text-white"
                                                                href="{{ route('season-group-in',[app()->getLocale(), $season->slug, $sub->inner_group->slug]) }}">{{ $sub->inner_group->title }}
                                                            </a>
                                                        </div>
                                                        <div class="submenu-transform megamenu-transform">
                                                            <ul class="megamenu list-unstyled">
                            ...
                            @if($promotions->count() > 0)
                                <li class="menu-list-item nav-item has-dropdown">
                                    <div class="mega-menu-header">
                                        <a class="nav-link" href="{{ route('promotions',app()->getLocale())}}"> SALE</a>
                                        <span class="open-submenu secondary-color">
                ...
                <div class="col-lg-2 col-md-2 col-md-10 col-6">
                    <div class="header-action d-flex align-items-center justify-content-end">
                        ...
                        <a class="header-action-item header-wishlist ms-4 d-none d-lg-block" href="{{route('wishlist', app()->getLocale() )}}">
                        ...
                        <a class="header-action-item header-login ms-4 d-lg-none " href="{{route('login',[app()->getLocale()])}}">
                        ...
                        <a class="header-action-item header-cart ms-4" href="#drawer-cart" data-bs-toggle="offcanvas">
                            ...
                            <p class="cardNumBadge addToCardNum">@if(Session::has('cart')) {{Session::get('cart')->where('country_id',session('user_currency')->id)->count()}} @endif </p> 
