            ...
            <div class="newsletter-container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-12">
                        <form action="{{ route('subscribe') }}" class="newsletter-form d-flex align-items-center rounded">@csrf
                            <input class="newsletter-input bg-transparent border-0" type="email" value="{{session()->get('subcriber')}}" @if (session()->has('subcriber'))readonly @endif name="email" placeholder="Enter your e-mail" autocomplete="off" required>
                            <button class="newsletter-btn rounded" type="submit" @if (session()->has('subcriber'))disabled @endif>
