...
@push('meta')
    ...
    <meta property="og:title" content="{{$season->title}}" />

    @php
       
    @endphp 
    <meta property="og:image" content="{{ asset($season->photo) }}">
    <meta property="og:image:secure_url" content="{{ asset($season->photo) }}">
...
?>
@section('title',$season->title.' Products | '.request()->get('system_title'))
...
@section('content')
                                ...
                                <div class="product-card">
                                    ...
                                    <div class="product-card-details">
                                        ...
                                        <h3 class="product-card-title">
                                            <a href="{{ route('product',[app()->getLocale(),$product->slug]) }}">
                                                {{$product->title}}
    ...
    <div class="modal fade" id="chirtModal" tabindex="-1" aria-hidden="true" style="display: none;">
        <pre style="padding:0;margin:0px;background:none;">{{ $season->description }}</pre>
    </div>
@endsection
@push('style')
