...
class OrderExport2 implements FromView, ShouldAutoSize,  Responsable, WithEvents
{
    use Exportable;
    ...
    public function view():view
    {
        if($this->date1){
            ...
            $orders =Order::whereBetween('order_date', [$start, $end])->orderBy('order_date', 'DESC')->get();
        }else{
